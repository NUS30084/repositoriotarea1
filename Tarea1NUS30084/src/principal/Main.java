...
//				int random_integer = rand.nextInt(max-min) + min;
	...
	private static void mostrarMenu() {
		...
		System.out.println("Pulse 1 para introducir 2 nºs enteros y que se muestre por pantalla un mensaje indicando si un valor es mayor que el otro o si son iguales.\n"
